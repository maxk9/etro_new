...
volatile                unsigned    char            CtNumberInd;
 ...
 volatile                 	unsigned    char         	CtError[16];
	const unsigned    char         	CtError0[16]={80,2,
									80,30,20,10,50,8,8,8,80,
									2,20,250,30,8};
