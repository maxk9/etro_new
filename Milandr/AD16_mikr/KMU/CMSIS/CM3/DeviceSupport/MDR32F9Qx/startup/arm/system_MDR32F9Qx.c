...
*  Clock Definitions
*******************************************************************************/
//  uint32_t SystemCoreClock = (uint32_t)16000000;         /*!< System Clock Frequency (Core Clock)
//                                                         *   default value */
	uint32_t SystemCoreClock = (uint32_t)64000000;         /*!< System Clock Frequency (Core Clock)
                                                         *   default value */
