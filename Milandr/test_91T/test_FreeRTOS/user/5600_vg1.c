...
const unsigned char uipIP_ADDR0 = 192,
					uipIP_ADDR1	= 168,
					uipIP_ADDR2	= 1,
					uipIP_ADDR3	= 87;	


//const struct uip_eth_addr mac = { { 0x94, 0xDE, 0x80, 0xD9, 0x0B, 0x47 } };
uint8_t mac[] = {  0x94, 0xDE, 0x80, 0xD9, 0x0B, 0x47  };
...
// 	Write_Word(0x5F4E,0x1FC7);    //MAC_ADDR_H = 0x4E5F;
	...
	Write_Word((uint16_t)(macadr[1]<<8)|macadr[0],0x1FC5);    //MAC_ADDR_T = 0x0A1B;
	Write_Word((uint16_t)(macadr[3]<<8)|macadr[2],0x1FC6);    //MAC_ADDR_M = 0x2C3D;
	Write_Word((uint16_t)(macadr[5]<<8)|macadr[4],0x1FC7);    //MAC_ADDR_H = 0x4E5F;
