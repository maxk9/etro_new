...
typedef struct
{
  ...
  __IO uint8_t  IP[8];                        /*!< Offset: 0x300  Interrupt Priority Register (8Bit wide) */
}  NVIC_Type;
...
typedef struct
{
  ...
  __IO uint32_t CCR;              /*!< Offset: 0x14  Configuration Control Register                        */
       uint32_t RESERVED2;
  __IO uint32_t SHP2;             /*!< Offset: 0x18  System Handlers Priority Register 2           */
...
/** @addtogroup CMSIS_CM1_ITM CMSIS CM1 ITM
...
#if ((defined __CM1_REV) && (__CM1_REV >= 0x200))
...
/** @addtogroup CMSIS_CM1_MPU CMSIS CM1 MPU
...
#ifndef IAR_ARM_CM1 // посмотреть данные функции и возможно просто убрать
/**
