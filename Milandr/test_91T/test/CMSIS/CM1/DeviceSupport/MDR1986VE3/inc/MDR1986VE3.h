...
/*----- 1986EV3 specific Interrupt Numbers -------------------------------------------------------*/
  ...
  ARINC429T1_IRQn			  = 21,		/*!< ARINC429 Transmitter 1 Interrupt					  */                         //!< ARINC429T1_IRQn
  ARINC429T2_IRQn			  = 22,		/*!< ARINC429 Transmitter 2 Interrupt					  */                         //!< ARINC429T2_IRQn
  ARINC429T3_IRQn			  = 23,		/*!< ARINC429 Transmitter 3 Interrupt					  */                         //!< ARINC429T3_IRQn
  ARINC429T4_IRQn			  = 24,		/*!< ARINC429 Transmitter 4 Interrupt 					  */                        //!< ARINC429T4_IRQn
...
#define RST_CLK_ADC_MCO_CLOCK_AUC_C1_SEL		((uint32_t)0x00030000)
#define RST_CLK_ADC_MCO_CLOCK_AUC_C2_SEL		((uint32_t)0x00300000)
#define RST_CLK_ADC_MCO_CLOCK_AUC_C3_SEL		((uint32_t)0x0F000000)
...
typedef struct {
  ...
  __IO uint32_t CCR31;
  __IO uint32_t CCR41;
  __IO uint32_t DMA_RE1;
  __IO uint32_t DMA_RE2;
  __IO uint32_t DMA_RE3;
  __IO uint32_t DMA_RE4;
} MDR_TIMER_TypeDef;
...
#define MDR_AUDIO_IP_BASE		  (0x40100000)	// 32
#define MDR_KEYBOARD_BASE		  (0x40108000)	// 33
#define MDR_LED_BASE			  (0x40110000)  // 34
#define MDR_PORTG_BASE			  (0x40118000) 	// 35
#define MDR_UART3_BASE			  (0x40120000) 	// 36
#define MDR_UART4_BASE			  (0x40128000)	// 37
#define MDR_SSP4_BASE			  (0x40130000)  // 38
#define MDR_PORTH_BASE			  (0x40138000) 	// 39
#define MDR_PORTI_BASE			  (0x40140000)  // 40
...
/*#define MDR_KEYBOARD			  ((MDR_KEYBOARD_TypeDef      *)MDR_KEYBOARD_BASE     )*/
