	...
	const unsigned    int 	CtRegim0=66;//2sec
	const unsigned    int 	CtRegim1=1000;//30sec
	const unsigned    int 	CtRegim2=300;//10sec
	const unsigned    int 	CtRegim3=10000;//300sec

	unsigned    char 	Regim[3];
	unsigned    int 	RegimError;
	unsigned    char	CtRevun;
    const unsigned    char		CtRevun0=33;
