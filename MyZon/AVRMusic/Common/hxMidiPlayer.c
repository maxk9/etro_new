...
typedef struct
{
    ...
    const flash uint8_t*                m_stream1_start;
    const flash uint8_t*                m_stream2_start;      
#else
...
///=====================================================
///=====================================================
uint16_t Player_Decompress( TCompressedStreamState* _state, const flash uint8_t* _streamBase, uint8_t _bitsCount, uint16_t _mask )
{
    uint8_t code;
...
void inline Player_ProcessEvents()
{
    ...
    s_playerState.m_eventCounter = 0xffffffff;
    #asm("sei")
