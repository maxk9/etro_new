...
void IndNoStop(void)
{
	static const char  Tab[]="Õ≈T Œ—“¿ÕŒ¬A";
	unsigned char R0,R1;
	SetCursor(0,0);
	ClearPoz(1);
	for(R0=0;R0<=11;++R0)
