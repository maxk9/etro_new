...
const uint8_t  
				KHU[]PROGMEM       ={0,0,0,0,43,57,52                },
				LG19U6[]PROGMEM    ={0,0,0,0,17,25,52,22             },
				...
				VOZB[]PROGMEM      ={35,47,40,34,52,39,37,38,46,41,64},
				MASLA[]PROGMEM     ={0,0,0,45,33,50,44,33            },

				TOG37C[]PROGMEM    ={0,0,51,47,39,28,19,23,50        },
				TOG8C[]PROGMEM     ={0,0,51,47,39,28,24,50           },

				DOZAPR[]PROGMEM    ={0,0,37,47,40,33,48,49,14        },

				OTKAZ[]PROGMEM     ={0,0,0,47,51,43,33,40            },
				LUKA[]PROGMEM      ={0,0,0,44,63,43,33               },
				PZA[]PROGMEM       ={0,0,0,52,48,48,33               },
				FVU[]PROGMEM       ={0,0,0,0,53,35,52                },
				VS[]PROGMEM        ={0,0,0,0,35,50                   },
				VG[]PROGMEM        ={0,0,0,0,35,36                   },
				...
				S_HSN[]PROGMEM     ={0,0,0,50,0,57,50,46             },
				S_MSHU[]PROGMEM    ={0,0,0,50,0,45,58,52             },
				S_RN[]PROGMEM      ={0,0,0,50,0,49,46                },

				SETI[]PROGMEM      ={0,0,0,0,50,38,51,61             },
				NO_NORM[]PROGMEM   ={0,0,46,38,0,46,47,49,45,33      },

				NA_KORPUSE[]PROGMEM={0,46,33,0,43,47,49,48,52,50,38  },

				OBRAT[]PROGMEM     ={0,0,0,47,34,49,33,51,14         },
				MOSHNOST[]PROGMEM  ={0,0,45,47,58,46,47,50,51,61     },

				AVARIA[]PROGMEM    ={0,0,0,33,35,33,49,41,64         },
				DVIGATEL[]PROGMEM  ={0,37,35,41,36,33,51,38,44,64    },
		...
		if(sec>1){
			...
			switch( RomReceive[ NumberIndicator ] )	{
				case 1:
					clear_lcd();
					//IndNoTopliva();
					Show_led_str((PGM_P)NO,0,7);
					Show_led_str((PGM_P)TOPLIVA,1,9);

					break;
				case 2:
					clear_lcd();
					//IndT8Gr();
					Show_led_str((PGM_P)TOG8C,0,8);
				...
				case 3:
					clear_lcd();
					//IndT37Gr();
					Show_led_str((PGM_P)TOG37C,0,9);
					//Show_led_str((PGM_P)DU,1,7);
					break;
				case 4:
					clear_lcd();
					//IndZashitaOff();
					Show_led_str((PGM_P)PROTECT,0,9);
					Show_led_str((PGM_P)OTKLYCHENA,1,10);
					break;
				case 5:
					clear_lcd();
					//IndOtkazLuk();
					Show_led_str((PGM_P)OTKAZ,0,8);
					Show_led_str((PGM_P)LUKA,1,7);
					break;

				case 6:
					clear_lcd();
					//IndLowIzol();
					Show_led_str((PGM_P)NIZKAYA,0,9);
					Show_led_str((PGM_P)ISOLYACIA,1,10);
					break;
				case 7:
					clear_lcd();
					//IndNoPusk();
					Show_led_str((PGM_P)NO,0,7);
					Show_led_str((PGM_P)PUSKA,1,8);
				...
				case 9:
					...
					//IndNoOborotov();
					Show_led_str((PGM_P)NO,0,7);
					Show_led_str((PGM_P)OBOROTOV,1,10);
				...
				case 11:
					...
					//IndErrorU();
					index_char[5]=65;
					Show_led_str((PGM_P)NO_NORM,1,10);
				...
				case 15:
					...
					//IndNoLinkRU();
					Show_led_str((PGM_P)NO_SVYAZ,0,10);
					Show_led_str((PGM_P)S_RN,1,7);

					break;
				case 16:
					clear_lcd();
					//IndObratnajaP();
					Show_led_str((PGM_P)OBRAT,0,9);
					Show_led_str((PGM_P)MOSHNOST,1,10);
					
					break;
				case 17:
					clear_lcd();
					//IndPeregruzKG();
					Show_led_str((PGM_P)PEREGRUZ,0,10);
					Show_led_str((PGM_P)VG,1,6);
					break;
					// case 18:
					// clear_lcd();
				...
				case 21:
					...
					//IndUKorpus();
					index_char[5]=65;
					Show_led_str((PGM_P)NA_KORPUSE,1,11);
					
					break;
				case 23:
					clear_lcd();
					//IndErrorSet();
					Show_led_str((PGM_P)SETI,0,8);
					Show_led_str((PGM_P)NO_NORM,1,10);
					break;
				case 24:
					clear_lcd();
					//IndNoMasla();
					Show_led_str((PGM_P)NO,0,7);
					Show_led_str((PGM_P)MASLA,1,8);
					break;
				case 25:
					clear_lcd();
					//IndDozapravkaTopliva();
					Show_led_str((PGM_P)DOZAPR,0,9);
					Show_led_str((PGM_P)TOPLIVA,1,9);
					break;
				case 26:
					clear_lcd();
				...
				case 28:
					clear_lcd();
					//IndAvarDvig();
					Show_led_str((PGM_P)AVARIA,0,9);
					Show_led_str((PGM_P)DVIGATEL,1,10);
					break;
				case 29:
					clear_lcd();
					//IndGotovMU();
				...
				case 32:
					...
					//IndNoLinkSN();
					Show_led_str((PGM_P)NO_SVYAZ,0,10);
					Show_led_str((PGM_P)S_HSN,1,8);
					break;
				case 33:
					clear_lcd();
					//IndOtkazPZA();
					Show_led_str((PGM_P)OTKAZ,0,8);
					Show_led_str((PGM_P)PZA,1,7);
					break;
